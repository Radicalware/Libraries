...
if(WIN32) 
    ...
    if(${debug})
        set(RE2_LIB_PATH "${RE2_DIR}/build/Debug/${PF}${RE2_LIB}.${ST}")
        link_directories("${RE2_DIR}/build/Debug")
    else()
        set(RE2_LIB_PATH "${RE2_DIR}/build/Release/${PF}${RE2_LIB}.${ST}")
        link_directories("${RE2_DIR}/build/Release")
    endif()
