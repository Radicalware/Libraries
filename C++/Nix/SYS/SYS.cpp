...
// -------------------------------------------------------------------------------
std::string SYS::file_data(){return m_file_data;}
std::string SYS::file_name(){return m_file_name;}

std::string SYS::command()  {return m_command;}
std::string SYS::read_command()  {return m_command;}
std::string SYS::cmd()  {return m_command;}
// -------------------------------------------------------------------------------
...
void SYS::p(T str){cout << endl << "------\n" << str << endl;}
void SYS::d(int i){cout << endl << "---{dbg: " << i << "}---" << endl;}
// -------------------------------------------------------------------------------
