...
void _pos_xy_pos_z(T list) {
	...
	cout << "(0, 0)\n" << ac::join(ac::dice(list, 0, 0), " ") << endl;
	cout << "0 1 2 3 4 5 6 7 8" << endl;
	cout << "\n(0, 0, 1)\n" << ac::join(ac::dice(list, 0, 0, 1), " ") << endl;
	cout << "blank - everything removed" << endl;
	cout << "\n(0, 0, 2)\n" << ac::join(ac::dice(list, 0, 0, 2), " ") << endl;
	cout << "1 3 5 7" << endl;
	cout << "\n(0, 0, 3)\n" << ac::join(ac::dice(list, 0, 0, 3), " ") << endl;
...
void _pos_xy_neg_z(T list) {
	...
	cout << "\n(8, 0, -1)\n" << ac::join(ac::dice(list, 8, 0, -1), " ") << endl;
	cout << "8 7 6 5 4 3 2 1 0" << endl;
	cout << "\n(8, 0, -2)\n" << ac::join(ac::dice(list, 8, 0, -2), " ") << endl;
	cout << "7 5 3 1" << endl;
	cout << "\n(8, 0, -3)\n" << ac::join(ac::dice(list, 8, 0, -3), " ") << endl;
...
void _neg_xy_neg_z(T list) {
	...
	cout << "\n(0, -8, -1)\n" << ac::join(ac::dice(list, -0, -8, -1), " ") << endl;
	cout << "8 7 6 5 4 3 2 1 0" << endl;
	cout << "\n(0, -8, -2)\n" << ac::join(ac::dice(list, -0, -8, -2), " ") << endl;
	cout << "7 5 3 1" << endl;
	cout << "\n(0, -8, -3)\n" << ac::join(ac::dice(list, -0, -8, -3), " ") << endl;
	cout << "7 6 4 3 1 0" << endl;
}
...
void fuzz_dice() {
	...
	cout << "there is no such thing as ac::join(ac::dice(list,,2)\n";
