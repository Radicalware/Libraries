...
public:
    ...
    inline constexpr bool has_value_in_lists(const V& input) const; // for Key-list-Pairs
    ...
    //inline constexpr const V& operator[](const K& key) const;
    ...
    inline constexpr xmap<const V*, const K*>* allocate_reverse_map();

    inline constexpr xvector<const K*> cached_keys() const; // remember to allocate 
    inline constexpr xmap<const V*, const K*> cached_rev_map() const; // remember to allocate 
...
//template<typename K, typename V>
//inline constexpr const V& xmap<K, V>::operator[](const K& key) const
//{
//    return this->at(key);
//}

//template<typename K, typename V>
//inline constexpr V& xmap<K, V>::operator[](const K& key)
//{
//    return this->at(key);
//}
...
template<typename K, typename V>
inline constexpr xmap<const V*, const K*>* xmap<K, V>::allocate_reverse_map()
{
    if (m_rev_map == nullptr)
...
template<typename K, typename V>
inline constexpr xmap<const V*, const K*> xmap<K, V>::cached_rev_map() const
{
    return *m_rev_map;
}
