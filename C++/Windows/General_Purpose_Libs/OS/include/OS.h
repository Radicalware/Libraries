...
private:
    ...
    File_Names id_files(xstring old_location, xstring new_location = "");
...
public:
    ...
    OS touch(const xstring& new_file = "");
    OS mkdir(const xstring& folder = "");

    OS cp(const xstring& old_location, const xstring& new_location = "");
    OS mv(const xstring& old_location, const xstring& new_location = "");
    OS rm(const xstring& new_file);
    ...
    OS move_file(const xstring& old_location, const xstring& new_location);
    OS move_dir(const xstring& old_location, const xstring& new_location);

    OS copy_file(const xstring& old_location, const xstring& new_location);
    OS copy_dir(const xstring& old_location, const xstring& new_location);

    OS delete_file(const xstring& content = "");
    OS delete_dir(const xstring& folder = "");

    OS clear_file(const xstring& content = "");
